...
#ifndef __HT32L5XXXX_CONF_H
#define __HT32L5XXXX_CONF_H
...
//    <i> RETARGET_UxART_CLKSEL
//    <i> 0 = Default Maximum (LIBCFG_MAX_SPEED)
//    <i> 1 = Manual Input (RETARGET_UxART_CLK_MANUAL)
//       <0=> Default Maximum (LIBCFG_MAX_SPEED)
//       <1=> Manual Input (RETARGET_UxART_CLK_MANUAL)
//  <o2> -- UxART IP Clock Manual Input (Hz)
//    <i> RETARGET_UxART_CLK_MANUAL
//    <i> Only meaningful when Core Clock Setting (RETARGET_UxART_CLKSEL) = Manual Input (1)
//  <q3> Enable Interrupt Mode for UxART Tx Retarget
//  <q4> Define UxARTn_IRQHandler By Retarget (ht32_serial.c)
...
//  <o5> Tx Buffer Length (in byte)
// </h>
*/
#define RETARGET_UxART_BAUDRATE       (115200)
#define RETARGET_UxART_CLKSEL         (0)         // 0 = Default Maximum (LIBCFG_MAX_SPEED), 1 = Manual Input (RETARGET_UxART_CLK_MANUAL)
#define RETARGET_UxART_CLK_MANUAL     (20000000)  // Only meaningful when RETARGET_UxART_CLKSEL = 1 (Manual Input)
#define RETARGET_INT_MODE             (0)
#define RETARGET_DEFINE_HANDLER       (1)
#define RETARGET_INT_BUFFER_SIZE      (64)

#if (RETARGET_UxART_CLKSEL==0)
#define RETARGET_UxART_CLK            LIBCFG_MAX_SPEED
#else
#define RETARGET_UxART_CLK            RETARGET_UxART_CLK_MANUAL
#endif
 ...
 * How to adjust the value of High Speed External oscillator (HSE)?
   ...
   or edit the "HSE_VALUE" in the "ht32l5xxxx_conf.h" file (this file).
*/
/*
//<e0> Enable User Define HSE Value
//  <i> Enable user define HSE value to overwrite default "HSE_VALUE" define in "ht32lxxxxx_nn.h".
//  <o1> HSE Value (Hz)
*/
#if (0)
...
/*
//<q> Enable Library Debug Mode
*/
#define HT32_LIB_DEBUG      0

/* The Libray Lite mode for reduce code size                                                                */
/*
//<q> Enable Library Lite Mode
//    <i> The Libray Lite mode for reduce code size.
*/
#define HT32_LIB_LITE      0
