...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 52353
STARTUP = startup_ht32l5xxxx_gcc_01
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32L52353_SK
C_OPTION += -DUSE_HT32L52343_53
C_OPTION += -DUSE_MEM_HT32L52353
S_OPTION = --defsym USE_HT32_CHIP=42
...
INCLUDE_PATH += -I./../../../../library/Device/Holtek/HT32L5xxxx/Include
INCLUDE_PATH += -I./../../../../library/HT32L5xxxx_Driver/inc
...
SOURCE_NAME_PATH += ../ht32l5xxxx_01_it.c
SOURCE_NAME_PATH += ../system_ht32l5xxxx_01.c
#SOURCE_NAME_PATH += ../ADD_YOUR_C_CODE_FILE_HERE.c

HT32_USB_PATH = ../../../../library/HT32_USBD_Library/src/
HT32_LIB_PATH = ../../../../library/HT32L5xxxx_Driver/src/
HT32_UTL_PATH = ../../../../utilities/

SOURCE_NAME_PATH += \
$(HT32_USB_PATH)ht32_usbd_core.c \
$(HT32_LIB_PATH)ht32_cm0plus_misc.c \
$(HT32_LIB_PATH)ht32l5xxxx_adc.c \
$(HT32_LIB_PATH)ht32l5xxxx_aes.c \
$(HT32_LIB_PATH)ht32l5xxxx_bftm.c \
$(HT32_LIB_PATH)ht32l5xxxx_ckcu.c \
$(HT32_LIB_PATH)ht32l5xxxx_cmp.c \
$(HT32_LIB_PATH)ht32l5xxxx_crc.c \
$(HT32_LIB_PATH)ht32l5xxxx_div.c \
$(HT32_LIB_PATH)ht32l5xxxx_ertc.c \
$(HT32_LIB_PATH)ht32l5xxxx_exti.c \
$(HT32_LIB_PATH)ht32l5xxxx_flash.c \
$(HT32_LIB_PATH)ht32l5xxxx_gpio.c \
$(HT32_LIB_PATH)ht32l5xxxx_i2c.c \
$(HT32_LIB_PATH)ht32l5xxxx_mctm.c \
$(HT32_LIB_PATH)ht32l5xxxx_pdma.c \
$(HT32_LIB_PATH)ht32l5xxxx_pwrcu.c \
$(HT32_LIB_PATH)ht32l5xxxx_rstcu.c \
$(HT32_LIB_PATH)ht32l5xxxx_rng.c \
$(HT32_LIB_PATH)ht32l5xxxx_sci.c \
$(HT32_LIB_PATH)ht32l5xxxx_spi.c \
$(HT32_LIB_PATH)ht32l5xxxx_tm.c \
$(HT32_LIB_PATH)ht32l5xxxx_usart.c \
$(HT32_LIB_PATH)ht32l5xxxx_usbd.c \
$(HT32_LIB_PATH)ht32l5xxxx_wdt.c \
