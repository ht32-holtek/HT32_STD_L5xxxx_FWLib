...
#endif
#if defined(__HT32F7XXXX_LIB_H)
#define MIN_HT32_FWLIB_VER              (0x00001001) //0xmmnnnrrr -> Vm.n.r
#define MIN_HT32_FWLIB_SVN              (0x78)
#endif
#include "ht32_dependency.h" // Not exist means the version of HT32 Firmware Library is older than the module required.
...
// Check "ht32l5xxxx_lib.h" for the version of HT32 Firmwar Library
