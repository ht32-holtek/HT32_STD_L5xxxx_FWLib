...
#ifndef __HT32L5XXXX_RTC_H
#define __HT32L5XXXX_RTC_H
...
typedef enum
{
  RTC_LSESM_NORMAL       = 0,       /*!< For backward compatibility, same with RTC_LSESM_SLOW.              */
  RTC_LSESM_FAST         = 2,       /*!< For backward compatibility, same with RTC_LSESM_MEDIUM_FAST.       */

  RTC_LSESM_SLOW         = 0,       /*!< Slow startup and requires least operating power.                   */
  RTC_LSESM_MEDIUM_SLOW  = 1,       /*!< Medium-slow startup and requires less operating power.             */
  RTC_LSESM_MEDIUM_FAST  = 2,       /*!< Medium-fast startup and requires more operating power.             */
  RTC_LSESM_SUPPER_FAST  = 3,       /*!< Fast startup and requires high operating current.                  */
} RTC_LSESM_Enum;
