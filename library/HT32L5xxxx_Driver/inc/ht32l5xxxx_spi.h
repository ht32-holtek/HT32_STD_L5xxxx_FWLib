...
#ifndef __HT32L5XXXX_SPI_H
#define __HT32L5XXXX_SPI_H
...
void SPI_SendData(HT_SPI_TypeDef* SPIx, u16 SPI_Data);
u16 SPI_ReceiveData(HT_SPI_TypeDef* SPIx);
void SPI_SetTimeOutValue(HT_SPI_TypeDef* SPIx, u16 SPI_Timeout);
