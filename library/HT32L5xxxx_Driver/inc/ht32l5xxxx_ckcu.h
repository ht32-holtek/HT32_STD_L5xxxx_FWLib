...
#ifndef __HT32L5XXXX_CKCU_H
#define __HT32L5XXXX_CKCU_H
...
#if ((LIBCFG_USBD) || (LIBCFG_CKCU_REFCLK_EXT_PIN))
/**
...
#define CKCU_LSITRIM_ACCURACY_0P0         (0)
#define CKCU_LSITRIM_ACCURACY_0P5         (8000 * 0.005)
#define CKCU_LSITRIM_ACCURACY_1P0         (8000 * 0.01)
#define CKCU_LSITRIM_ACCURACY_1P5         (8000 * 0.015)
#define CKCU_LSITRIM_ACCURACY_2P0         (8000 * 0.02)
#endif

/* HSE Gain mode                                                                                            */
#define CKCU_HSE_LOW_GAIN_MODE          ((0UL << 12) | (0UL << 8))
#define CKCU_HSE_MEDIUM_LOW_GAIN_MODE   ((0UL << 12) | (1UL << 8))
#define CKCU_HSE_MEDIUM_HIGH_GAIN_MODE  ((1UL << 12) | (0UL << 8))
#define CKCU_HSE_HIGH_GAIN_MODE         ((1UL << 12) | (1UL << 8))
/**
  * @}
  */
