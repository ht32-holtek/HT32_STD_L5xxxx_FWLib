...
#ifndef __HT32L5XXXX_BFTM_H
#define __HT32L5XXXX_BFTM_H
...
void BFTM_SetCompare(HT_BFTM_TypeDef* HT_BFTMn, u32 uCompare);
u32 BFTM_GetCompare(HT_BFTM_TypeDef* HT_BFTMn);
void BFTM_SetCounter(HT_BFTM_TypeDef* HT_BFTMn, u32 uCounter);
