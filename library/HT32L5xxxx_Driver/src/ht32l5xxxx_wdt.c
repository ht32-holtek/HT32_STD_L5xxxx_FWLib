...
/*********************************************************************************************************//**
 * @brief Configure the WDT to run or halt in sleep and deep sleep1~3 mode.
 * @param WDT_Mode:
 *   This parameter can be one of the following values:
 *     @arg WDT_SLEEP_HALT_NONE      : WDT no halt
 *     @arg WDT_SLEEP_HALT_DEEPSLEEP : WDT halts in deep sleep1~3 mode
 *     @arg WDT_SLEEP_HALT_ALL       : WDT halts in sleep and deep sleep1~3 mode
 * @retval None
 ************************************************************************************************************/
