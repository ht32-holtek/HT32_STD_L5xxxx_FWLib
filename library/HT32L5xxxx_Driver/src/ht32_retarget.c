...
void RETARGET_Configuration(void)
{
  ...
  */
  ...
  #endif
  #if (HT32_LIB_LITE == 1) && defined(RETARGET_UxART_CLK)
  USART_InitStructure.USART_BaudRateReg = RETARGET_UxART_CLK / RETARGET_UxART_BAUDRATE;
  #endif
  ...
  HT32_DVB_COMInit(RETARGET_COM_PORT, &USART_InitStructure);
  #else
