/*********************************************************************************************************//**
 * @file    example/ht32_usbd_descriptor.c
 * @version $Rev:: 1008         $
...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  DESC_LEN_XXX,               // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_01_XXX,           // bDescriptorType     1 XXX Descriptor type
  DESC_H2B(0x0110),           // bcdXXX              2 XXX Specification Release Number
  0x21,                       // bCountryCode        1 Country code of the localized hardware
  0x01,                       // bNumDescriptors     1 Number of class descriptors (at least 1)
  DESC_TYPE_02_XXX,           // bDescriptorType     1 REPORT Descriptor Type
  DESC_H2B(DESC_LEN_XXXX),    // bDescriptorLength   2 Total size of the Report descriptor
