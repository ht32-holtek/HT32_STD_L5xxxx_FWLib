/*********************************************************************************************************//**
 * @file    ht32l52353_sk.h
 * @version $Rev:: 1008         $
 * @date    $Date:: 2025-08-28 #$
 * @brief   The header file of HT32l52353 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32L52353_SK_H
#define __HT32L52353_SK_H
...
/** @addtogroup HT32L52353_SK
  * @{
  */

/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32L52353_SK_Exported_Constants HT32L52353 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32L52353_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32L52353_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32L52353_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32L52353_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32L52353_SK_SPI_LCD
  * @{
  */
...
/** @addtogroup HT32L52353_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32L52353_SK_Exported_Functions HT32L52353 Starter kit exported functions
  * @{
  */
#define HT32_DVB_USBConnect()                USBD_DPpullupCmd(ENABLE)
#define HT32_DVB_USBDisConnect()             USBD_DPpullupCmd(DISABLE)
#define HT32_DVB_GPxConfig                   AFIO_GPxConfig

#define HT32_DVB_BuzzerInit(hFreq, bDuty)    HT32_DVB_BuzzerFun(hFreq, bDuty, 0);
#define HT32_DVB_BuzzerConfig(hFreq, bDuty)  HT32_DVB_BuzzerFun(hFreq, bDuty, 1);
