...
void LCD_Init(void)
{
  ...
  */
  ...
  HT32_DVB_GPxConfig(LCD_EBI_CS_GPIO_ID, LCD_EBI_CS_AFIO_PIN, LCD_EBI_CS_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_OE_GPIO_ID, LCD_EBI_OE_AFIO_PIN, LCD_EBI_OE_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_WE_GPIO_ID, LCD_EBI_WE_AFIO_PIN, LCD_EBI_WE_AFIO_MODE);
  #if (SPIDUALOUT_WITH_EBI_8BIT_MODE == 0)
  HT32_DVB_GPxConfig(LCD_EBI_RS_GPIO_ID, LCD_EBI_RS_AFIO_PIN, LCD_EBI_RS_AFIO_MODE);
  #else
  HT32_DVB_GPxConfig(LCD_EBI_RS1_GPIO_ID, LCD_EBI_RS1_AFIO_PIN, LCD_EBI_RS1_AFIO_MODE);
  #endif
  HT32_DVB_GPxConfig(LCD_EBI_AD0_GPIO_ID, LCD_EBI_AD0_AFIO_PIN, LCD_EBI_AD0_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD1_GPIO_ID, LCD_EBI_AD1_AFIO_PIN, LCD_EBI_AD1_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD2_GPIO_ID, LCD_EBI_AD2_AFIO_PIN, LCD_EBI_AD2_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD3_GPIO_ID, LCD_EBI_AD3_AFIO_PIN, LCD_EBI_AD3_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD4_GPIO_ID, LCD_EBI_AD4_AFIO_PIN, LCD_EBI_AD4_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD5_GPIO_ID, LCD_EBI_AD5_AFIO_PIN, LCD_EBI_AD5_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD6_GPIO_ID, LCD_EBI_AD6_AFIO_PIN, LCD_EBI_AD6_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD7_GPIO_ID, LCD_EBI_AD7_AFIO_PIN, LCD_EBI_AD7_AFIO_MODE);
  #if (LCD_BIT_MODE == LCD_16_BIT_MODE)
  HT32_DVB_GPxConfig(LCD_EBI_AD8_GPIO_ID, LCD_EBI_AD8_AFIO_PIN, LCD_EBI_AD8_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD9_GPIO_ID, LCD_EBI_AD9_AFIO_PIN, LCD_EBI_AD9_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD10_GPIO_ID, LCD_EBI_AD10_AFIO_PIN, LCD_EBI_AD10_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD11_GPIO_ID, LCD_EBI_AD11_AFIO_PIN, LCD_EBI_AD11_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD12_GPIO_ID, LCD_EBI_AD12_AFIO_PIN, LCD_EBI_AD12_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD13_GPIO_ID, LCD_EBI_AD13_AFIO_PIN, LCD_EBI_AD13_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD14_GPIO_ID, LCD_EBI_AD14_AFIO_PIN, LCD_EBI_AD14_AFIO_MODE);
  HT32_DVB_GPxConfig(LCD_EBI_AD15_GPIO_ID, LCD_EBI_AD15_AFIO_PIN, LCD_EBI_AD15_AFIO_MODE);
  #endif
  #if (LCD_EBI_BL_ENABLE == 1)
  HT32_DVB_GPxConfig(LCD_EBI_BL_GPIO_ID, LCD_EBI_BL_GPIO_PIN, LCD_EBI_BL_AFIO_MODE);
  #endif
  #if (LCD_EBI_RST_UNUSE == 0)
  HT32_DVB_GPxConfig(LCD_EBI_RST_GPIO_ID, LCD_EBI_RST_GPIO_PIN, LCD_EBI_RST_AFIO_MODE);
  #endif
