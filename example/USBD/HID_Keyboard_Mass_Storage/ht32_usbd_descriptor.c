...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  CLASS_INF0_CLASS,           // bInterfaceClass     1 Class code (assigned by USB-IF)
  CLASS_INF0_SUBCLASS,        // bInterfaceSubClass  1 Subclass code (assigned by USB-IF)
  CLASS_INF0_PTCO,            // bInterfaceProtocol  1 Protocol code (assigned by USB)
  ...
  CLASS_INF1_CLASS,           // bInterfaceClass     1 Class code (assigned by USB-IF)
  CLASS_INF1_SUBCLASS,        // bInterfaceSubClass  1 Subclass code (assigned by USB-IF)
  CLASS_INF1_PTCO,            // bInterfaceProtocol  1 Protocol code (assigned by USB)
  0x00,                       // iInterface          1 Index of string descriptor describing this interface
  ...
  DESC_LEN_EPT,               // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_05_EPT,           // bDescriptorType     1 ENDPOINT Descriptor Type
  0x03,                       // bEndpointAddress    1 The address of the endpoint
                              //                        Bit 3..0: The endpoint number
                              //                        Bit 6..4: Reserved
                              //                        Bit 7   : Direction (0 = Out/1 = In)
  0x02,                       // bmAttribute         1 Endpoint Attribute
...
__ALIGN4 static uc8 guUSB_StringDescProduct[] =
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  DESC_STRLEN(11),            // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_03_STR,           // bDescriptorType     1 STRING Descriptor Type
...
__ALIGN4 static u8 guUSB_StringDescSerialNum[] =
{
  ...
  DESC_TYPE_03_STR,           // bDescriptorType     1 STRING Descriptor Type
  DESC_CHAR('0'),             // bString             N UNICODE encoded string
  DESC_CHAR('0'),
  DESC_CHAR('0'),
  DESC_CHAR('0'),
  DESC_CHAR('0'),
