/*********************************************************************************************************//**
 * @file    USBD/HID_Keyboard_Mass_Storage/ht32_usbd_descriptor.h
 * @version $Rev:: 872          $
...
/* Exported constants --------------------------------------------------------------------------------------*/
#define DESC_LEN_CONFN_T          (u16)(DESC_LEN_CONFN + DESC_LEN_INF + DESC_LEN_HID + DESC_LEN_EPT * 1 + DESC_LEN_INF + DESC_LEN_EPT * 2)
