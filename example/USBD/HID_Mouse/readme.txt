...
and Endpoint interrupt transfer. This example uses key on the development board to emulate
mouse cursor and key.
<PRE>
  Key                    Function
  ==================     ==================
  Wakeup                 Mouse cursor right
  Key1                   Mouse left key
...
- USBD/HID_Mouse/ht32lxxxxx_nn_it.c                        Interrupt handlers
- USBD/HID_Mouse/ht32lxxxxx_nn_usbdconf.h                  USB Device Library configuration file
