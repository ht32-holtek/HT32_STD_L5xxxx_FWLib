...
static void USBDClass_EPT1INProcess(void)
{
  ...
  {
    gMouseInfo.Button.bits.B1 = !HT32_DVB_PBGetState(BUTTON_KEY1);
    gMouseInfo.Button.bits.B2 = !HT32_DVB_PBGetState(BUTTON_KEY2);

    if (HT32_DVB_PBGetState(BUTTON_WAKEUP))
