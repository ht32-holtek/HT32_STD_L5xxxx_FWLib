/**
 @page USBD_HID_Keyboard_Virtual_COM

 @verbatim
 * @file    USBD/HID_Keyboard_Virtual_COM/readme.txt
 * @version V1.00
 * @date    2018-06-29
 * @brief   Description of USB Device HID Keyboard + Virtual COM example.
 @endverbatim

@par Example Description:

The USB Device HID Keyboard + Virtual COM example code which shows how to use HT32 USB Device Library, enumeration,
and Endpoint interrupt/bulk transfer. This example uses button and LED on the development board to emulate
Number Lock, Caps Lock, and Scroll Lock of Keyboard. Besides, this example shows the following mesasage when
open on the terminal program and simply loopback the Virtual COM bulk out to the bulk in.
...
- USBD/HID_Keyboard/main.c                                          Main program
- USBD/HID_Keyboard/ht32lxxxxx_nn_it.c                              Interrupt handlers
- USBD/HID_Keyboard/ht32lxxxxx_nn_usbdconf.h                        USB Device Library configuration file
- USBD/HID_Keyboard/ht32_usbd_class.c                               USB Device Class related function
- USBD/HID_Keyboard/ht32_usbd_class.h                               Header file of the USB Device Class
- USBD/HID_Keyboard/ht32_usbd_descriptor.c                          Descriptor of USB Device
- USBD/HID_Keyboard/ht32_usbd_descriptor.h                          Header file of the USB Device Descriptor
...
firmware library by setting USBDCORE_ENABLE_LOW_POWER as 1 (in the ht32lxxxx_usbdconf.h file).
