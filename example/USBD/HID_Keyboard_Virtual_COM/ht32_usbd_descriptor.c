...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  0x03 + RETARGET_INF,        // bNumberInterface    1 Number of interfaces supported by this configuration
  ...
  1,                          // bNumEndpoints       1 Number of endpoints used by this interface
  COMMUNICATION_INF_CLASS,    // bInterfaceClass     1 Class code (assigned by USB-IF)
  COMMUNICATION_INF_SUBCLASS, // bInterfaceSubClass  1 Subclass code (assigned by USB-IF)
  COMMUNICATION_INF_PTCO,     // bInterfaceProtocol  1 Protocol code (assigned by USB)
  0x00,                       // iInterface          1 Index of string descriptor describing this interface
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  CDC_HEADER_LEN,             // bFunctionLength     1 Size of this descriptor in bytes
  CDC_TYPE_24_INF,            // bDescriptorType     1 CS_INTERFACE descriptor type
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  CDC_ABSTRACT_LEN,           // bFunctionLength     1 Size of this descriptor in bytes
  CDC_TYPE_24_INF,            // bDescriptorType     1 CS_INTERFACE descriptor type
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  CDC_UNION_LEN,              // bFunctionLength     1 Size of this descriptor in bytes
  CDC_TYPE_24_INF,            // bDescriptorType     1 CS_INTERFACE descriptor type
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  CDC_CALL_LEN,               // bFunctionLength     1 Size of this descriptor in bytes
  CDC_TYPE_24_INF,            // bDescriptorType     1 CS_INTERFACE descriptor type
  ...
  DATA_INF_CLASS,             // bInterfaceClass     1
