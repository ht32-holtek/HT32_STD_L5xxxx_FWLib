/*********************************************************************************************************//**
 * @file    USBD/HID_Keyboard_Virtual_COM/main.c
 * @version $Rev:: 872          $
 * @date    $Date:: 2025-08-12 #$
 * @brief   The main program of USB Device HID Keyboard + Virtual COM example.
 *************************************************************************************************************
 * @attention
 *
...
int main(void)
{
  ...
  HT32_DVB_PBInit(BUTTON_WAKEUP, BUTTON_MODE_EXTI);
  HT32_DVB_PBInit(BUTTON_KEY1, BUTTON_MODE_EXTI);
  HT32_DVB_PBInit(BUTTON_KEY2, BUTTON_MODE_EXTI);
