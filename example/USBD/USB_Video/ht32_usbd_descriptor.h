/*********************************************************************************************************//**
 * @file    USBD/USB_Video/ht32_usbd_descriptor.h
 * @version $Rev:: 872          $
...
/* Exported constants --------------------------------------------------------------------------------------*/
#define DESC_LEN_CONFN_T          (u16)(DESC_LEN_CONFN + IAD_LEN_INF + DESC_LEN_INF * 3 + DESC_LEN_EPT * 2 \
                                    + VC_TotalLength + UVC_LEN_EPT + VS_TotalLength)
