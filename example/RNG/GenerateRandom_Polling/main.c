/*********************************************************************************************************//**
 * @file    RNG/GenerateRandom_Polling/main.c
 * @version $Rev:: 276          $
...
/** @addtogroup GenerateRandom_Polling GenerateRandom_Polling
  * @{
  */
...
void GenRandom_BlockingMode(void)
{
  ...
  while(RNG_GetFlagStatus(HT_RNG, RNG_FLAG_VALID) == RESET)
  {
  }
...
void GenRandom_MainRoutine(void)
{
    ...
    {
      if(RNG_GetFlagStatus(HT_RNG, RNG_FLAG_VALID) == SET)
      {
