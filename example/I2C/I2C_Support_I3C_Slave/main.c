...
/** @addtogroup I2C_Support_I3C_Slave
  * @{
  */
...
void I2C_Slave_Configuration(void)
{
  ...
  { /* I2C Slave configuration                                                                              */
    ...
    */
    ...
    /* !!! NOTE !!!
       To support I3C communication, configure the I2C Sequential Filter
       to filter out high-level pulses shorter than 50 ns.
       Filter duration is calculated as:
       ...
       meeting I3C signal filtering requirements.
    */
    I2C_SequentialFilterConfig(HTCFG_I2C_SLAVE_PORT, HTCFG_I2C_SEQ_FILTER);
  }
