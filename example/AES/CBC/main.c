...
{
  0xa7, 0xc3, 0x9f, 0x7c, 0x41, 0xe8, 0xb1, 0x77,
  0xf5, 0xf1, 0xd3, 0xed, 0xca, 0xf5, 0xac, 0xb5,
  0xa6, 0xfb, 0x06, 0x5b, 0xcd, 0x6a, 0x83, 0x11,
  0x39, 0xb9, 0x62, 0x52, 0x8b, 0xb2, 0x0e, 0x81
};
...
{
  /* Encryption                                                                                             */
  if (!AES_CBC_CryptData(HT_AES, AES_DIR_ENCRYPT, (u32*)u8InitVector, BUFF_SIZE, (u32*)u8OrgData, (u32*)u8CipherText))
  {
  ...
  /* Decryption                                                                                             */
  if (!AES_CBC_CryptData(HT_AES, AES_DIR_DECRYPT, (u32*)u8InitVector, BUFF_SIZE, (u32*)u8CipherText, (u32*)u8PlainText))
  {
    /* Input length must be a multiple of 16                                                                */
