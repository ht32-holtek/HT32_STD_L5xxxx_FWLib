...
{
  0xfc, 0xad, 0x71, 0x5b, 0xd7, 0x3b, 0x5c, 0xb0,
  0x48, 0x8f, 0x84, 0x0f, 0x3b, 0xad, 0x78, 0x89,
  0x0e, 0xd2, 0xe6, 0x32, 0xaf, 0xcd, 0xfe, 0x08,
  0x35, 0xe5, 0x02, 0x66, 0x89, 0x08, 0x91, 0x22
};
...
{
  /* Encryption                                                                                             */
  if (!AES_ECB_CryptData(HT_AES, AES_DIR_ENCRYPT, BUFF_SIZE, (u32*)u8OrgData, (u32*)u8CipherText))
  {
  ...
  /* Decryption                                                                                             */
  if (!AES_ECB_CryptData(HT_AES, AES_DIR_DECRYPT, BUFF_SIZE, (u32*)u8CipherText, (u32*)u8PlainText))
  {
    /* Input length must be a multiple of 16                                                                */
