...
int main(void)
{
  ...
  /*
      Configure the system clock in startup file (startup_ht32lxxxx.s)
      by calling SystemInit function. Please refer to system_ht32lxxxx.c.
  */
