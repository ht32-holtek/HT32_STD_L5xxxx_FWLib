/**
 @page CKCU_HSI_AutoTrim_By_LSE

 @verbatim
 * @file    CKCU/HSI_AutoTrim_By_LSE/readme.txt
 * @version V1.00
 * @date    2021-04-21
...
The example shows how to use the HSI Auto Trim function by LSE.

@par Directory Contents:

- CKCU/HSI_AutoTrim_By_LSE/main.c                           Main program
- CKCU/HSI_AutoTrim_By_LSE/ht32lxxxxx_nn_it.c               Interrupt handlers
