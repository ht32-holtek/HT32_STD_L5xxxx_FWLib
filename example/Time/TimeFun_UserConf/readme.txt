...
older firmware library. User can copy the "ht32_time_conf.h" and following files into their code to use it.
  //library/HT32Lxxxxx_Driver/src/ht32_time.c
  //library/HT32Lxxxxx_Driver/inc/ht32_time.h
...
<PRE>
  Configuration:
    The following setting in the file, "ht32lxxxxx_conf.h" (It also has an alternately one in user space,
...
- Time/TimeFun_UserConf/ht32lxxxxx_nn_it.c                  Interrupt handlers
