...
/*********************************************************************************************************//**
  ...
  *     - Turn off LED1.
  *     - Request to enter Deep Sleep mode 3 (The LDO is disable and ULDO is ON).
  *     - Turn on LED1 when the system has resumed from Deep Sleep mode 3.
  *
  ***********************************************************************************************************/
int main(void)
{
  ...
  while (HT32_DVB_PBGetState(BUTTON_KEY1) == 0x1);
  ...
  while (1)
  {
    ...
    /* Request to enter Deep Sleep mode 3                                                                   */
    PWRCU_DeepSleep3(PWRCU_SLEEP_ENTRY_WFI);
