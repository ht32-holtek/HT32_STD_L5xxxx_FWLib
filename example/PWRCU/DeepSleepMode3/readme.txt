/**
 @page PWRCU_DeepSleepMode3

 @verbatim
 * @file    PWRCU/DeepSleepMode3/readme.txt
 * @version V1.00
 * @date    2024-03-19
 * @brief   Description of PWRCU Deep Sleep mode 3 example.
 @endverbatim

@par Example Description:

This example shows how to drive the system into Deep Sleep mode 3 and be waken up by WAKEUP pin 
...
- Turn off LED1
- Enter Deep Sleep mode 3
- Turn on LED1

Three leds LED1, LED2 and LED3 are used to monitor the system state as following:
- LED1  on: system in RUN mode
- LED1 off: system in Deep Sleep mode 3
- LED2  on: if Wakeup pin is used to exit from Deep Sleep mode 3
- LED3  on: if RTC Compare Match is used to exit from Deep Sleep mode 3

@par Directory Contents:

- PWRCU/DeepSleepMode3/main.c                   Main program
- PWRCU/DeepSleepMode3/ht32lxxxx_it.c           Interrupt handlers

@par Hardware and Software Environment:

- This example can be run on HT32 Series development board.

@note For power consumption measurement in Deep Sleep mode 3:
...
- The debug adapter such as e-Link32 can not communicate with the chip when it enters into Deep Sleep Mode.
