...
This example describes how to save users' data in the backup domain. As long as the power is not turned off, 
the backup data will be retained after a reset.  
...
- PWRCU/BackupData/ht32lxxxx_it.c           Interrupt handlers
