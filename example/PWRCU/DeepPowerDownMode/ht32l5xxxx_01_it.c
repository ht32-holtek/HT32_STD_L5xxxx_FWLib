/*********************************************************************************************************//**
 * @file    PWRCU/DeepPowerDownMode/ht32l5xxxx_01_it.c
 * @version $Rev:: 352          $
 ...
 *    - Request to enter Deep Power Down Mode (Both the LDO and the ULDO are disable).
 ************************************************************************************************************/
