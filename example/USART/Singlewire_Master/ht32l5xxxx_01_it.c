/*********************************************************************************************************//**
 * @file    USART/Singlewire_Master/ht32l5xxxx_01_it.c
 * @version $Rev:: 509          $
...
void HTCFG_UART_IRQHandler(void)
{
  ...
  extern u32  gURTx_Length;
  extern u8   *gURRx_Ptr;
  extern u32  gURRx_Length;

  extern u32 gURSlave_Length;
  extern vu32 gRx_Match_Flag;

#if (DEBUG_IO == 1)
  #define DBG_IO1_LO()    HT32_DVB_LEDOn(HT_LED1)
  #define DBG_IO1_HI()    HT32_DVB_LEDOff(HT_LED1)
  #define DBG_IO2_LO()    HT32_DVB_LEDOn(HT_LED2)
  #define DBG_IO2_HI()    HT32_DVB_LEDOff(HT_LED2)
#else
  #define DBG_IO1_LO(...)
  #define DBG_IO1_HI(...)
  #define DBG_IO2_LO(...)
  ...
  if (USART_GetFlagStatus(HTCFG_UART_PORT, USART_FLAG_RXDR))
  {
    ...
    if (gURRx_Length == gURSlave_Length)
    {
      gRx_Match_Flag = TRUE;
    }
