...
void Flash_Test(void)
{
  ...
  /* Disable and Enable Cache to insure the Flash read is correct                                           */
...
void InitVector(u32 uSource, u32 uRAMAddress)
{
  ...
  vu32 *Source; /* Fix the issue of Arm Compiler Version V6.18 (u32 -> vu32)                                */
  Source = (vu32 *)uSource;
