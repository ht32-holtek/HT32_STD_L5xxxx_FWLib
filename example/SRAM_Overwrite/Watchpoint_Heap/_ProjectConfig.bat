...
REM ============================================================================
gsar.exe -s"//BS Write __HT_check_heap, 2" -r"BS Write __HT_check_heap, 2" MDK_ARM\HT32??xxxx_01_DebugSupport.ini -o
gsar.exe -s"//BS Write __HT_check_heap, 2" -r"BS Write __HT_check_heap, 2" MDK_ARMv5\HT32???xxxx_01_DebugSupport.ini -o
gsar.exe -s"//BS Write __HT_check_heap, 2" -r"BS Write __HT_check_heap, 2" MDK_ARMv537\HT32??xxxx_01_DebugSupport.ini -o