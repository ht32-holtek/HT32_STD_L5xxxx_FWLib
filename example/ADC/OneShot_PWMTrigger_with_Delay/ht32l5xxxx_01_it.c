/*********************************************************************************************************//**
 * @file    ADC/OneShot_PWMTrigger_with_Delay/ht32l5xxxx_01_it.c
 * @version $Rev:: 283          $
 ...
 * @retval  None
 ************************************************************************************************************/
void HTCFG_PWM_IRQHandler(void)
{
  if (TM_GetIntStatus(HTCFG_PWM_TM_PORT, TM_INT_CH3CC) == SET)
  {
    TM_ClearIntPendingBit(HTCFG_PWM_TM_PORT, TM_INT_CH3CC);
